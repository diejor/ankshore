...
func ensure_initialized() -> void:
	...
	# NOTE: On native, make sure somewhere (e.g. Autoload) you did:
	...
	var config := {"iceServers": []} # local only
	...
	# Attach to WebRTCMultiplayerPeers while connections are NEW.
	...
	# SDP wiring (no create_answer in Godot API!).
...
func reset() -> void:
	# Simple version: just drop references; next ensure_initialized() creates a new pair.
	server_peer = null
	client_peer = null
	pc_server = null
	pc_client = null
